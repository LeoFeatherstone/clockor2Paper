...
\author{Leo A. Featherstone$^{\ast,1}$, Sebastian Duchene$^{\dagger,1}$, Wytamma Wirth$^{\dagger,1}$\\}
\date{}
...
\caption{lockor2 presents the tree along size RTT regression data. Users can toggle between local and global clocks and alter the appearance of the tree.}
\label{fig:ui}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|}
        ...
        \hline
    \end{tabular}
    \caption{Time taken to find the best fitting root for test trees of 100, 500, 1000, and 5000 tips using Clockor2 and TempEst v1.5.3 on a 2021 Macbook woth 16Gb of memory and 8 cores running chrome v113.0.5627.126. Times vary with computer and browser. In general the relative efficieny of Clockor2 will inrease with the number of cores.}
    \label{tab:bfr}
\end{table}
